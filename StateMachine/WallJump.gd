...
func check_walljump():
	...
	var is_right = player.get_right_collider() and player.get_right_collider().get_class() in CanWallJumpTypes and Input.is_action_pressed("right")
	var is_left = player.get_left_collider() and player.get_left_collider().get_class() in CanWallJumpTypes and Input.is_action_pressed("left")
